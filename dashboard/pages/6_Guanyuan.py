...
kota = pd.read_csv("https://raw.githubusercontent.com/swanru/dicoding-submission/main/PRSA_Data_Guanyuan_20130301-20170228.csv")
def data():
    st.write("Dataset")
    st.write(kota.head())
...
st.title('Kualitas Udara Kota Guanyuan')
data()